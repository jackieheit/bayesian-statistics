...
5. You can use the R function qbeta to find quantiles of a beta distribution. For example, let’s
suppose we want to find the median (0.5 quantile, i.e. 50th percentile) of a beta(3, 2) distribution.
...
the median of a beta(3, 2) distribution is about 0.61. Use qbeta to compute the following:
